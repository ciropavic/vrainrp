...
Config.Item1 = 'tar' -- The Item that you Farm
...
Config.CircleZones = {
	FarmField = {coords = vector3(1070.2980957031,2237.4228515625,44.436706542969), name = _U('blip_FarmField'), color = 1, sprite = 514, radius = 10},
}
