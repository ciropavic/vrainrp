...
Config.Item1 = 'tus' -- The Item that you Farm
...
Config.CircleZones = {
	FarmField = {coords = vector3(929.74786376953,2444.2075195313,49.430477142334), name = _U('blip_FarmField'), color = 1, sprite = 514, radius = 10},
}
