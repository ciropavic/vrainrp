...
Config.Item1 = 'feherpor' -- The Item that you Farm
...
Config.CircleZones = {
	FarmField = {coords = vector3(407.29730224609,6482.9360351563,28.80912399292), name = _U('blip_FarmField'), color = 1, sprite = 514, radius = 10},
}
