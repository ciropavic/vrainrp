                ...
                if (marker) then 
                    for ped in EnumeratePeds() do 
                        ...
                        if (not marker.entitiesIn[ped] and dist <= marker.radius) then 
                            ...
                            TriggerEvent(Config.resource..':onMarkerHit', i, ped, player == ped, marker.data);
                        elseif (marker.entitiesIn[ped] and dist > marker.radius) then 
                            marker.entitiesIn[ped] = nil;
                            TriggerEvent(Config.resource..':onMarkerLeave', i, ped, player == ped, marker.data);
                        end
                    end
                end
            end 
...
AddEventHandler(Config.resource..':CreateMarker', function(id, x, y, z, type, radius, r, g, b, a, data)
