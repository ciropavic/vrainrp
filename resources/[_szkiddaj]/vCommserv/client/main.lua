...
AddEventHandler('esx_communityservice:inCommunityService', function(actions_remaining)
	...
	while actionsRemaining > 0 and communityServiceFinished ~= true do
		...
		if (
			GetDistanceBetweenCoords(GetEntityCoords(playerPed), Config.ServiceLocation.x, Config.ServiceLocation.y, Config.ServiceLocation.z) > 45 and 
			actionsRemaining > 0 and
...
RegisterNetEvent('esx_communityservice:updateCount')
AddEventHandler('esx_communityservice:updateCount', function(count)
						...
						if (tmp_action.type == "cleaning") then
							...
							ESX.Streaming.RequestAnimDict("amb@world_human_janitor@male@idle_a", function()
								...
								ESX.SetTimeout(10000, function()
									...
									TriggerServerEvent('esx_communityservice:doComservAction');
								end)
