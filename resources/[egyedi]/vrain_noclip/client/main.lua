...
RegisterKeyMapping('noclip', 'Noclip ki/bekapcsolása', 'keyboard', Config.Controls.toggle)
RegisterKeyMapping('noclip_cam', 'Noclip Kamera', 'keyboard', Config.Controls.camMode)
RegisterKeyMapping('noclip_speed', 'Noclip Gyorsaság', 'keyboard', Config.Controls.changeSpeed)