Locales['en'] = {
  -- Cloakroom   ['cloakroom'] = 'locker room',
  ...
  ['armory'] = 'armory',
  ['open_armory'] = 'Nyomd meg az ~INPUT_CONTEXT~ gombot, hogy megnyisd a raktárat.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ...
  ['search'] = 'Ember átkutatása',
  ['handcuff'] = 'kötözés / elengedés',
  ['drag'] = 'Játékos cipelése',
  ...
  ['owner'] = 'owner: %s',
  -- Boss Menu
  ['open_bossmenu'] = 'Nyomd meg az ~INPUT_CONTEXT~ gombot, hogy megnyisd a panelt',
