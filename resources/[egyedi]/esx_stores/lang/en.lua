...
Lang['en'] = {
    ['open'] = "~w~[~g~E~w~] a megnyitáshoz",
    ['open_market'] = "~w~[~g~E~w~] a bolt megnyitásához",
    ...
    ['buy_message'] = "Ennek a boltnak nincs tulajdonosa.",
    ['already_has_business'] = "Már van egy boltod.",
    ['already_has_owner'] = "Ennek a boltnak már van tulajdonosa.",
    ['businnes_bougth'] = "Congratulations, you have purchased a store",
    ['insufficient_funds'] = "Nincsen elegendő pénzed.",
    ['money_withdrawn'] = "Pénz sikeresen kivéve.",
    ['money_deposited'] = "Money deposited",
    ['invalid_value'] = "Érvénytelen szám",
    ...
    ['bought_item'] = "Tárgy megvásárolva: %s %s",
    ['bought_item_2'] = "Vásároltál: %s %s",
    ['sell_error'] = "Nem adhatod el a boltot.",
    ['store_sold'] = "Eladtad a boltot.",

    ['logs_date'] = "Dátum",
    ['logs_hour'] = "Idő",
    ['logs_bought'] = "```prolog\n[BOLT MEGVÁSÁROLVA]: %s \n[ID]: %s \r```",
    ['logs_close'] = "```prolog\n[BOLT BEZÁRVA]: %s \n[ID]: %s \r```",
    ['logs_item_bought'] = "```prolog\n[TÁRGY MEGVÁSÁROLVA]: %s\n[TÁRGY]: %s [MENNYISÉG]: %s \n[ID]: %s \r```",
}