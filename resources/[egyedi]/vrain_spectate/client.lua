Panel = {
	...
	spectate = function(self, data, cb)
		...
		if serverId == GetPlayerServerId(PlayerId()) then
			return exports['vrain_notify']:showNotify('Nem tudod nézni saját magadat.', 'error', 4000)
		end
...
RegisterCommand("spectateoff", function()
	if Panel.selectedPlayer then
		exports['vrain_notify']:showNotify('Nézés kikapcsolva.', 'normal', 4000)
		Panel:spectateoff()
	end
end)
RegisterKeyMapping("spectateoff", "Spectate kikapcsolás", "keyboard", "e")
