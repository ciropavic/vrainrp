...
Config.Strings = {
	ExitVehicle = "Szállj ki a járműből a tankoláshoz",
	EToRefuel = "[~g~E~w~] Tankolás",
	JerryCanEmpty = "A kanna üres.",
	FullTank = "Jármű tele van tankolva.",
	PurchaseJerryCan = "Vásároltál egy kannát " .. Config.JerryCanCost .."$-ért.",
	CancelFuelingPump = "[~r~E~w~] Megállítás",
	CancelFuelingJerryCan = "[~r~E~w~] Megállítás",
	NotEnoughCash = "Nincsen elegendő pénzed",
	RefillJerryCan = "Újratöltötted a kannát. ",
	NotEnoughCashJerryCan = "Nincsen elegendő pénzed",
	JerryCanFull = "A kanna tele van.",
	TotalCost = "Költség",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Vásároltál egy kannát."
	Config.Strings.RefillJerryCan = "Újratöltötted a kannát."
end
