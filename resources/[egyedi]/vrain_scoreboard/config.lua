...
config.whitelistedjobs = {
    [1] = {name = 'police', fa = '<i class="fad fa-siren-on"></i>', label = 'Rendőr'},
    [2] = {name = 'sheriff', fa = '<i class="fas fa-badge-sheriff"></i>', label = 'Sheriff'},
    [3] = {name = 'deltaforce', fa = '<i class="fas fa-police-box"></i>', label = 'Delta Force'},
    [4] = {name = 'mechanic', fa = '<i class="fad fa-car-mechanic"></i>', label = 'Szerelő'},
    [5] = {name = 'ambulance', fa = '<i class="fas fa-user-md"></i>', label = 'Mentő'},
}
