...
RegisterCommand('mdt', function()
    if ESX.PlayerData.job.name == 'police' or ESX.PlayerData.job.name == 'sheriff' or ESX.PlayerData.job.name == 'deltaforce' then
...
RegisterNUICallback('takeMugshot', function(data, cb)
	...
	if retval then
		exports['screenshot-basic2']:requestScreenshotUpload('DISCORD_WEBHOOK_HERE', data.field, function(data)
