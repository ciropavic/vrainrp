...
-- Police Settings:
Config.PoliceJobs = {"police", "sheriff"}	-- Jobs that can't do bankrobberies etc, but can secure the banks.

-- Alert Blip
Config.AlertBlipShow = true			-- enable or disable blip on map on police notify
Config.AlertBlipTime = 15000			-- miliseconds that blip is active on map (this value is multiplied with 4 in the script)
...
Config.SafeMoneyReward = {{
	...
	minAmount = 10,				-- this value is multiplied with 1000 in script, so 15 means 15.000$
	maxAmount = 11,				-- this value is multiplied with 1000 in script, so 30 means 30.000$
}}
...
Config.Camera = {
	[1] = {pos = {153.15,-1042.05,29.37}, heading = 44.32, name = 'Fleeca Bank [Legion Square] Kamera #1'},
	[2] = {pos = {143.1,-1042.76,29.37}, heading = 235.08, name = 'Fleeca Bank [Legion Square] Kamera #2'},
	[3] = {pos = {149.73,-1051.26,29.35}, heading = 16.87, name = 'Fleeca Bank [Legion Square] Kamera #3'},
	--
	[4] = {pos = {317.63,-280.51,54.16}, heading = 46.96, name = 'Fleeca Bank [Alta] Kamera #1'},
	[5] = {pos = {307.43,-281.14,54.16}, heading = 229.91, name = 'Fleeca Bank [Alta] Kamera #2'},
	[6] = {pos = {314.07,-289.63,54.14}, heading = 24.06, name = 'Fleeca Bank [Alta] Kamera #3'},
	--
	[7] = {pos = {-347.51,-51.26,49.04}, heading = 44.82, name = 'Fleeca Bank [Burton] Kamera #1'},
	[8] = {pos = {-357.61,-51.92,49.04}, heading = 230.92, name = 'Fleeca Bank [Burton] Kamera #2'},
	[9] = {pos = {-350.91,-60.51,49.01}, heading = 28.09, name = 'Fleeca Bank [Burton] Kamera #3'},
	--
	[10] = {pos = {-1209.33,-329.2,37.78}, heading = 83.18, name = 'Fleeca Bank [Rockford Hills] Kamera #1'},
	[11] = {pos = {-1215.84,-336.86,37.78}, heading = 270.99, name = 'Fleeca Bank [Rockford Hills] Kamera #2'},
	[12] = {pos = {-1205.0,-338.07,37.76}, heading = 66.41, name = 'Fleeca Bank [Rockford Hills] Kamera #3'},
	--
	[13] = {pos = {1171.39,2706.91,38.09}, heading = 243.26, name = 'Fleeca Bank [Grand Senora Desert] Kamera #1'},
	[14] = {pos = {1180.68,2710.88,38.09}, heading = 63.94, name = 'Fleeca Bank [Grand Senora Desert] Kamera #2'},
	[15] = {pos = {1171.55,2716.84,38.07}, heading = 226.04, name = 'Fleeca Bank [Grand Senora Desert] Kamera #3'},
	--
	[16] = {pos = {-2962.26,486.62,15.7}, heading = 158.82, name = 'Fleeca Bank [Great Ocean Highway] Kamera #1'},
	[17] = {pos = {-2958.7,477.21,15.7}, heading = 341.95, name = 'Fleeca Bank [Great Ocean Highway] Kamera #2'},
	[18] = {pos = {-2952.44,485.95,15.68}, heading = 134.42, name = 'Fleeca Bank [Great Ocean Highway] Kamera #3'},
	--
	[19] = {pos = {-108.86,6461.75,31.63}, heading = 357.17, name = 'Blaine County Savings Bank Kamera #1'},
	[20] = {pos = {-103.91,6466.68,31.63}, heading = 89.7, name = 'Blaine County Savings Bank Kamera #2'},
	[21] = {pos = {-102.28,6468.39,31.63}, heading = 29.87, name = 'Blaine County Savings Bank Kamera #3'},
	[22] = {pos = {-104.54,6479.56,31.63}, heading = 176.15, name = 'Blaine County Savings Bank Kamera #4'},
	--
	[23] = {pos = {233.11,221.94,106.29}, heading = 207.24, name = 'Pacific Standard Bank Kamera #1'},
	[24] = {pos = {241.76,214.98,106.29}, heading = 283.2, name = 'Pacific Standard Bank Kamera #2'},
	[25] = {pos = {258.99,204.19,110.29}, heading = 320.66, name = 'Pacific Standard Bank Kamera #3'},
	[26] = {pos = {252.48,229.25,106.29}, heading = 157.75, name = 'Pacific Standard Bank Kamera #4'},
	[27] = {pos = {252.0,225.43,101.68}, heading = 271.93, name = 'Pacific Standard Bank Kamera #5'},
	--
}