...
AddEventHandler(
    "t1ger_bankrobbery:loadDataCL",
    function(BankData, SafesData)
        Banks = BankData
...
AddEventHandler(
    "t1ger_bankrobbery:getPoliceCount",
    function(policeData)
        Police = policeData
    end
)
...
AddEventHandler(
    "t1ger_bankrobbery:KeypadStateCL",
    function(id, state, type)
...
AddEventHandler(
    "t1ger_bankrobbery:OpenVaultDoorCL",
    function(k, v, DoorHeading, amount)
...
AddEventHandler(
    "t1ger_bankrobbery:CloseVaultDoorCL",
    function(k, v, DoorHeading, amount)
        local PlayerPos = GetEntityCoords(PlayerPedId(), true)
...
AddEventHandler(
    "t1ger_bankrobbery:deskCashCL",
    function(id, num, state)
        if id ~= nil or state ~= nil then
...
AddEventHandler(
    "t1ger_bankrobbery:addRobTimeCL",
    function(timer)
        robTime = timer
    end
)
...
AddEventHandler(
    "t1ger_bankrobbery:pacificSafeCL",
    function(id, state)
        if id ~= nil or state ~= nil then
...
AddEventHandler(
    "t1ger_bankrobbery:OpenDeskDoorCL",
    function(k, v, DoorHeading, amount)
        local PlayerPos = GetEntityCoords(PlayerPedId(), true)
...
AddEventHandler(
    "t1ger_bankrobbery:CloseDeskDoorCL",
    function(k, v, DoorHeading, amount)
        local PlayerPos = GetEntityCoords(PlayerPedId(), true)
...
AddEventHandler(
    "t1ger_bankrobbery:ResetCurrentBankCL",
    function()
        -- Banks:
...
AddEventHandler(
    "t1ger_bankrobbery:openCameraView",
    function(cameraNum)
