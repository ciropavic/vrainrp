Panel = {
	...
	spectate = function(self, data, cb)
		...
		if serverId == GetPlayerServerId(PlayerId()) then
			return exports['vrain_notify']:showNotify('Nem figyelheted meg saját magadat!', 'error', 7000)
		end
...
function updatePlayerInfo()
	while Panel.selectedPlayer do
		...
		SendNUIMessage({
			playerInfo = {
				"Halhatatlanság: "
					.. (GetPlayerInvincible(Panel.selectedPlayer) and RED .. "Bekapcsolva" or GREEN .. "Kikapcsolva")
					.. "</span>",
				"AntiRagdoll: "
					.. (not CanPedRagdoll(targetPed) and RED .. "Bekapcsolva" or GREEN .. "Kikapcsolva")
					.. "</span>",
				"Életerő: " .. GetEntityHealth(targetPed) .. "/" .. GetEntityMaxHealth(targetPed),
...
RegisterCommand("spectateoff", function()
	if Panel.selectedPlayer then
		exports['vrain_notify']:showNotify('Megfigyelésből sikeresen kiléptél!', 'success', 7000)
		Panel:spectateoff()
	end
end)
