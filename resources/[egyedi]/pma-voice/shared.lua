...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.5, "Suttogás"}, -- Whisper speech distance in gta distance units
		{3.0, "Normál"}, -- Normal speech distance in gta distance units
		{6.0, "Kiabálás"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "Suttogás"}, -- Whisper speech distance in gta distance units
		{7.0, "Normál"}, -- Normal speech distance in gta distance units
		{15.0, "Kiabálás"} -- Shout speech distance in gta distance units
	}
end
