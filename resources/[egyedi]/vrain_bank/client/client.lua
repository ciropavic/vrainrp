...
local bankMenu	= true
local banks = {
	--{name="Banque", id=208, x=-200.955, y=-1308.913, z=31.29},
	{name="Bank", id=208, x=-1212.980, y=-330.841, z=37.787},
	-- {name="Bank", id=208, x=-30.64, y=-1106.72, z=26.42},
	-- {name="Bank", id=208, x=-38.177, y=-1115.5, z=26.43},
	{name="Bank", id=208, x=-2962.582, y=482.627, z=15.703},
	{name="Bank", id=208, x=-112.202, y=6469.295, z=31.626},
	{name="Bank", id=208, x=314.187, y=-278.621, z=54.170},
	{name="Bank", id=208, x=-351.534, y=-49.529, z=49.042},
	{name="Bank", id=208, x=241.727, y=220.706, z=106.286},
	{name="Bank", id=208, x=1175.0643310547, y=2706.6435546875, z=38.094036102295},
	{name="Bank", id=208, x=150.12298583984, y=-1039.5882568359, z=29.36798286438}
}	
...
local atms = {
	...
	{name="ATM", id=277, x=-549.58, y=-204.4, z=38.22},
	{name="ATM", id=277, x=472.39, y=-1001.64, z=30.69},
	{name="ATM", id=277, x=468.07, y=-990.73, z=26.27},
	{name="ATM", id=277, x=-1390.75, y=-590.11, z=30.32},
	{name="ATM", id=277, x=-1578.4313964844, y=-3002.9111328125, z=-79.005935668945},
	{name="ATM", id=277, x=315.17736816406, y=-593.63507080078, z=43.284057617188},
...
if bankMenu then
	...
	if nearBank() or nearATM() then
			DisplayHelpText("Nyomd meg a(z) ~INPUT_PICKUP~ gombot, a bank használatához~b~")
...
Citizen.CreateThread(function()
	if showblips then
		...
		local zoneblip = AddBlipForRadius(v.x, v.y, v.z, 70.0)
