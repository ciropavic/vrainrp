Locales['en'] = {
  ...
  ['give_to'] = 'Átadás',
  ['amount'] = 'Mennyiség',
  ['giveammo'] = 'Lőszer átadás',
  ['amountammo'] = 'lőszer mennyiség',
  ['noammo'] = 'Nincsen elegendő lőszered!',
  ...
  ['received_help'] = 'Megkaptad a jóléti csekked: ~g~$%s~s~',
  ['company_nomoney'] = 'A frakciód túl eszgény, hogy kifizessen',
  ['received_paycheck'] = 'Kapott fizetés.',
  ['bank'] = 'VrainCity Bank',
  ['account_bank'] = 'Bank',
  ['account_black_money'] = 'Fekete pénz',
