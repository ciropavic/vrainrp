...
-- ESX.RegisterCommand('setjob', 'adminseged', function(xPlayer, args, showError)
...
-- ESX.RegisterCommand('setaccountmoney', 'foadmin', function(xPlayer, args, showError)
...
-- ESX.RegisterCommand('giveaccountmoney', 'foadmin', function(xPlayer, args, showError)
-- 	if args.playerId.getAccount(args.account) then
...
if not Config.OxInventory then
	ESX.RegisterCommand('giveitem', 'foadmin', function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('giveweapon', 'foadmin', function(xPlayer, args, showError)
		if args.playerId.hasWeapon(args.weapon) then
			showError(_U('command_giveweapon_hasalready'))
		else
			args.playerId.triggerEvent("player:receiveItem",args.weapon, args.ammo)
		end
	...
	ESX.RegisterCommand('giveweaponcomponent', 'foadmin', function(xPlayer, args, showError)
...
-- ESX.RegisterCommand({'clearall', 'clsall'}, 'adminseged', function(xPlayer, args, showError)
...
-- ESX.RegisterCommand('goto', "adminseged", function(xPlayer, args, showError)
...
-- ESX.RegisterCommand('bring', "adminseged", function(xPlayer, args, showError)
...
-- ESX.RegisterCommand('freeze', "adminseged", function(xPlayer, args, showError)
-- 	args.playerId.triggerEvent('esx:freezePlayer', "freeze")
-- end, true, {help = _U('kill'), validate = true, arguments = {
-- {name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
-- }})

-- ESX.RegisterCommand('unfreeze', "adminseged", function(xPlayer, args, showError)
