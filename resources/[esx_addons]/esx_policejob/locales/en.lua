Locales['en'] = {
  ...
  ['armory_bought'] = 'vásároltál: ~y~%s~s~ ennyiért: ~r~%s $~s~',
  ...
  ['vehicleshop_bought'] = 'vásároltál ~y~%s~s~ ezért: ~r~%s $~s~',
  ...
  ['confiscate_dirty'] = 'fekete pénz elkobzása: <span style="color:red;">%s $</span>',
  ['you_confiscated'] = 'elkoboztad ~y~%sx~s~ ~b~%s~s~ töle: ~b~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~b~%s~s~ elkobozta: ~y~%s~s~',
  ['you_confiscated_account'] = 'elkoboztad ~g~%s $~s~ (%s) töle ~b~%s~s~',
