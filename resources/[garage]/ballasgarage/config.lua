...
Config.BallasDatabaseName = 'ballas'	-- set the exact name from your jobs database for police
...
Config.CarZones = {
	BallasCarGarage = {
		Pos = {
			{x = 104.49880218506,  y = -1940.3914794922, z = 20.8037109375}
		}
	}
}
...
Config.CarGarageName = "Ballas Garázs"
...
Config.BallasCarMarker = 23 												-- marker type
Config.BallasCarMarkerColor = { r = 255, g = 0, b = 55, a = 100 } 			-- rgba color of the marker
Config.BallasCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "~g~[E]~s~ ~r~Garázs megnyitása~s~"			-- set your desired text here

-- Police Heli Garage Marker Settings:
Config.BallasHeliMarker = 27 												-- marker type
Config.BallasHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.BallasHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "Press ~g~[E]~s~ to open ~y~heli garage~s~"		-- set your desired text here

-- Police Boat Garage Marker Settings:
Config.BallasBoatMarker = 27 												-- marker type
Config.BallasBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.BallasBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "Press ~g~[E]~s~ to open ~y~garage boat"		-- set your desired text here

-- -- Police Cars:
Config.BallasVehicles = {
	...
	{ model = 'skyline', label = 'Nissan Skyline', price = 0 },
}
...
Config.TitleBallasGarage = "GARÁZS"
