...
Config.MotoGangDatabaseName = 'motogang'	-- set the exact name from your jobs database for police
...
Config.CarZones = {
	MotoGangCarGarage = {
		Pos = {
			{x = 972.47509765625,  y = -122.95668792725, z = 74.330070495605}
		}
	}
}
...
Config.CarGarageName = "Moto Gang Garázs"
...
Config.MotoGangCarMarker = 23 												-- marker type
Config.MotoGangCarMarkerColor = { r = 255, g = 0, b = 55, a = 100 } 			-- rgba color of the marker
Config.MotoGangCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "~g~[E]~s~ ~r~Garázs megnyitása~s~"			-- set your desired text here

-- Police Heli Garage Marker Settings:
Config.MotoGangHeliMarker = 27 												-- marker type
Config.MotoGangHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.MotoGangHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "Press ~g~[E]~s~ to open ~y~heli garage~s~"		-- set your desired text here

-- Police Boat Garage Marker Settings:
Config.MotoGangBoatMarker = 27 												-- marker type
Config.MotoGangBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.MotoGangBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "Press ~g~[E]~s~ to open ~y~garage boat"		-- set your desired text here

-- -- Police Cars:
Config.MotoGangVehicles = {
	{ model = 'burrito3', label = 'Burrito', price = 0 },
	{ model = 'africat', label = 'Honda CRF1000L Africa Twin', price = 0 },
...
Config.TitleMotoGangGarage = "GARÁZS"
