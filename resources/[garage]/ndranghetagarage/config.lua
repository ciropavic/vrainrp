...
Config.NdranghetaDatabaseName = 'ndrangheta'	-- set the exact name from your jobs database for police
...
Config.CarZones = {
	NdranghetaCarGarage = {
		Pos = {
			{x = -24.376752853394,  y = -1436.9515380859, z = 30.653142929077}
		}
	}
}
...
Config.CarGarageName = "Ndrangheta Garázs"
...
Config.NdranghetaCarMarker = 23 												-- marker type
Config.NdranghetaCarMarkerColor = { r = 255, g = 0, b = 55, a = 100 } 			-- rgba color of the marker
Config.NdranghetaCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "~g~[E]~s~ ~r~Garázs megnyitása~s~"			-- set your desired text here

-- Police Heli Garage Marker Settings:
Config.NdranghetaHeliMarker = 27 												-- marker type
Config.NdranghetaHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.NdranghetaHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "Press ~g~[E]~s~ to open ~y~heli garage~s~"		-- set your desired text here

-- Police Boat Garage Marker Settings:
Config.NdranghetaBoatMarker = 27 												-- marker type
Config.NdranghetaBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.NdranghetaBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "Press ~g~[E]~s~ to open ~y~garage boat"		-- set your desired text here

-- -- Police Cars:
Config.NdranghetaVehicles = {
...
Config.TitleNdranghetaGarage = "GARÁZS"
