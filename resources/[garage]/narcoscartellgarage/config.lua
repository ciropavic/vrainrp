...
Config.NarcoscartellDatabaseName = 'narcoscartel'	-- set the exact name from your jobs database for police


--Police Car Garage:
Config.CarZones = {
	NarcoscartellCarGarage = {
		Pos = {
			{x = 1349.6025390625,  y = 1147.1655273438, z = 113.75896453857}
		}
	}
}
...
Config.CarGarageName = "Narcos Cartel Garázs"
...
Config.NarcoscartellCarMarker = 23 												-- marker type
Config.NarcoscartellCarMarkerColor = { r = 255, g = 0, b = 55, a = 100 } 			-- rgba color of the marker
Config.NarcoscartellCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "~g~[E]~s~ ~r~Garázs megnyitása~s~"			-- set your desired text here

-- Police Heli Garage Marker Settings:
Config.NarcoscartellHeliMarker = 27 												-- marker type
Config.NarcoscartellHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.NarcoscartellHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "Press ~g~[E]~s~ to open ~y~heli garage~s~"		-- set your desired text here

-- Police Boat Garage Marker Settings:
Config.NarcoscartellBoatMarker = 27 												-- marker type
Config.NarcoscartellBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.NarcoscartellBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "Press ~g~[E]~s~ to open ~y~garage boat"		-- set your desired text here

-- -- Police Cars:
Config.NarcoscartellVehicles = {
...
Config.TitleNarcoscartellGarage = "GARÁZS"
