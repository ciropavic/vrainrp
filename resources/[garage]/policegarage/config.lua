...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = 596.00335693359,  y = -4.544912815094, z = 70.628105163574}
		}
	}
}
...
Config.HeliZones = {
	PoliceHeliGarage = {
		Pos = {
			{x = 579.84545898438, y = 12.988246917725, z = 103.23313903809}
		}
	}
}
...
Config.PoliceVehicles = {
	...
	{ model = 'nkbuffalos', label = 'Bravado Buffalo S', price = 0 },
	{ model = 'char', label = 'Dodge Charger', price = 0 },
	{ model = 'explorer', label = 'Ford Explorer', price = 0 },
	{ model = 'nkcruiser', label = 'Police Cruiser Stanier', price = 0 }
}
