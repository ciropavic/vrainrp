...
Config.MiragliaDatabaseName = 'miraglia'	-- set the exact name from your jobs database for police
...
Config.CarZones = {
	MiragliaCarGarage = {
		Pos = {
			{x = -1331.7584228516,  y = -1093.3920898438, z = 6.9742531776428}
		}
	}
}
...
Config.CarGarageName = "Miraglia Garázs"
...
Config.MiragliaCarMarker = 23 												-- marker type
Config.MiragliaCarMarkerColor = { r = 255, g = 0, b = 55, a = 100 } 			-- rgba color of the marker
Config.MiragliaCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "~g~[E]~s~ ~r~Garázs megnyitása~s~"			-- set your desired text here

-- Police Heli Garage Marker Settings:
Config.MiragliaHeliMarker = 27 												-- marker type
Config.MiragliaHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.MiragliaHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "Press ~g~[E]~s~ to open ~y~heli garage~s~"		-- set your desired text here

-- Police Boat Garage Marker Settings:
Config.MiragliaBoatMarker = 27 												-- marker type
Config.MiragliaBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.MiragliaBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "Press ~g~[E]~s~ to open ~y~garage boat"		-- set your desired text here

-- -- Police Cars:
Config.MiragliaVehicles = {
...
Config.TitleMiragliaGarage = "GARÁZS"
