...
Config.PoliceDatabaseName = 'deltaforce'	-- set the exact name from your jobs database for police
...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = 2040.0576171875,  y = 3449.7800292969, z = 43.878189086914}
		}
	}
}
...
Config.HeliZones = {
	PoliceHeliGarage = {
		Pos = {
			{x = 2063.1811523438, y = 3469.9094238281, z = 45.093391418457}
		}
	}
}
...
Config.PoliceVehicles = {
	{ model = 'g63amg6x6', label = 'G63 AMG 6X6', price = 0 },
	{ model = 'm5rb_vv', label = 'BMW M5', price = 0 },
	{ model = 'landstalkervip', label = 'Landstalker', price = 0 },
	{ model = 'armyinsurgent', label = 'Army Insurgent', price = 0 },
	{ model = 'rmodgt63', label = 'GT63', price = 0 }
}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'mhx', label = 'Helikopter', price = 0 }
}
...
Config.TitlePoliceGarage = "GARÁZS"
