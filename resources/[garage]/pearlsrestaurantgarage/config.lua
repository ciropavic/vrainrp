...
Config.PearlsRestaurantDatabaseName = 'pearlsrestaurant'	-- set the exact name from your jobs database for police


--Police Car Garage:
Config.CarZones = {
	PearlsRestaurantCarGarage = {
		Pos = {
			{x = 109.53439331055,  y = -1035.3503417969, z = 29.35147857666}
		}
	}
}
...
Config.CarGarageName = "Narcos Cartell Garázs"
...
Config.PearlsRestaurantCarMarker = 23 												-- marker type
Config.PearlsRestaurantCarMarkerColor = { r = 255, g = 0, b = 55, a = 100 } 			-- rgba color of the marker
Config.PearlsRestaurantCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "~g~[E]~s~ ~r~Garázs megnyitása~s~"			-- set your desired text here

-- Police Heli Garage Marker Settings:
Config.PearlsRestaurantHeliMarker = 27 												-- marker type
Config.PearlsRestaurantHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.PearlsRestaurantHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "Press ~g~[E]~s~ to open ~y~heli garage~s~"		-- set your desired text here

-- Police Boat Garage Marker Settings:
Config.PearlsRestaurantBoatMarker = 27 												-- marker type
Config.PearlsRestaurantBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.PearlsRestaurantBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "Press ~g~[E]~s~ to open ~y~garage boat"		-- set your desired text here

-- -- Police Cars:
Config.PearlsRestaurantVehicles = {
	{ model = 'gburrito2', label = 'Burrito', price = 0 },
	{ model = 'seminole2', label = 'Seminole', price = 0 },
	{ model = 'brioso', label = 'Brioso', price = 0 },
	{ model = 'bobcatxl', label = 'Bobcat XL', price = 0 }
}

-- Police Helicopters:
Config.LaCosaHelicopters = {
	{ model = 'daemon2', label = 'Daemon High', price = 0 },
...
Config.TitlePearlsRestaurantGarage = "GARÁZS"
