...
Config.LostMCDatabaseName = 'lostmc'	-- set the exact name from your jobs database for police
...
Config.CarZones = {
	LostMCCarGarage = {
		Pos = {
			{x = 94.864112854004,  y = 3732.1567382813, z = 39.882403564453}
		}
	}
}
...
Config.CarGarageName = "LostMC Garázs"
...
Config.LostMCCarMarker = 23 												-- marker type
Config.LostMCCarMarkerColor = { r = 255, g = 0, b = 55, a = 100 } 			-- rgba color of the marker
Config.LostMCCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "~g~[E]~s~ ~r~Garázs megnyitása~s~"			-- set your desired text here

-- Police Heli Garage Marker Settings:
Config.LostMCHeliMarker = 27 												-- marker type
Config.LostMCHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.LostMCHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "Press ~g~[E]~s~ to open ~y~heli garage~s~"		-- set your desired text here

-- Police Boat Garage Marker Settings:
Config.LostMCBoatMarker = 27 												-- marker type
Config.LostMCBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.LostMCBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "Press ~g~[E]~s~ to open ~y~garage boat"		-- set your desired text here

-- -- Police Cars:
Config.LostMCVehicles = {
...
Config.TitleLostMCGarage = "GARÁZS"
