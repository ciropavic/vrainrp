...
local zones = {
	-----Fo publik
	{ ['x'] = 227.75003051758, ['y'] = -784.95031738281, ['z'] = 30.716928482056 },
------------------------------------------------------------
---KORHAZ
		{ ['x'] = 308.15, ['y'] = -588.61, ['z'] = 10.28 },
------------------------------------------------------------
-----HKS
    	{ ['x'] = -334.29, ['y'] = -124.5, ['z'] = 30.01 },
		{ ['x'] = -388.58, ['y'] = -105.44, ['z'] = 30.68 },
		{ ['x'] = -363.91, ['y'] = -163.96, ['z'] = 30.1 },
-----------------------------------------------------------------
---MUNKAUGYI
		{ ['x'] = -261.77, ['y'] = -970.73, ['z'] = 25.22 },
-----------------------------------------------------------------
--KOZMUNKA
		{ ['x'] = -952.52, ['y'] = 310.77, ['z'] = 60.16 },
-----------------------------------------------------------------
...
--[[Citizen.CreateThread(function()
	...
	for i = 1, #zones, 1 do
		...
		AddTextComponentString("Biztonsági Zóna") -- What it will say when you hover over the blip on your map.
		...
		if dist <= 50.0 then  ------------------------------------------------------------------------------ Here you can change the RADIUS of the Safe Zone. Remember, whatever you put here will DOUBLE because 
			if not notifIn then																			  -- it is a sphere. So 50 will actually result in a diameter of 100. I assume it is meters. No clue to be honest.
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Be léptél egy publikus helyre</b>",
					type = "success",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
			...
			if not notifOut then
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Elhagytál egy publikus helyet</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
		...
		DisablePlayerFiring(player,true) -- Disables firing all together if they somehow bypass inzone Mouse Disable
      	DisableControlAction(0, 106, true) -- Disable in-game mouse controls
			if IsDisabledControlJustPressed(2, 37) then --if Tab is pressed, send error message
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>A publikus helyeken fegyvert nem használhatsz</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
			...
			if IsDisabledControlJustPressed(0, 106) then --if LeftClick is pressed, send error message
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Ezen a területen nem tudsz semmit se csinálni!</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
